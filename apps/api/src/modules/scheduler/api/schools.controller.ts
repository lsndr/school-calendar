...
export class SchoolsController {
  ...
  @Get()
  public async findMany(): Promise<SchoolDto[]> {
  ...
  @ApiOkResponse({ type: SchoolDto })
  @Post()
  public async create(@Body() payload: CreateSchoolDto): Promise<SchoolDto> {
  ...
  @ApiNotFoundResponse()
  @Get('/:id')
  public async findById(@Param('id') id: string): Promise<SchoolDto> {
